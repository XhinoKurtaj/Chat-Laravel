...
@section('content-attachment-details')
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-3">
                <a href="/home/conversation/{{$attachmentDetails[0]->conversation->id}}/download/{{$attachmentDetails[0]->id}}"><img src="/storage/{{$mime}}" id="img" class=" shadow p-3 mb-5 bg-white rounded" ></a>
            </div>
            <div class="col-md-9">
            @else
                <div class="container">
        ...
        <br><hr>
        <a href="{{ route('attachments.table') }}" class="btn btn-outline-secondary"><i class="fas fa-arrow-circle-left"></i> Back</a>
    </div>
@endsection
